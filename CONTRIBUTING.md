...
4. Make your changes
5. Test thoroughly: `python3 0-proto/test_suite.py --test all`
...
```bash
# Run all tests
python3 0-proto/test_suite.py --test all

# Run specific test category
python3 0-proto/test_suite.py --test cache
python3 0-proto/test_suite.py --test edge
```
